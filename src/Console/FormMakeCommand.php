...
namespace BalajiDharma\LaravelFormBuilder\Console;
...
class FormMakeCommand extends GeneratorCommand
{
    ...
    {
        return [
            ['name', InputArgument::REQUIRED, 'Full class name of the desired form class.'],
        ];
    }
    ...
    protected function getOptions()
    {
        return [
            ...
            ['path', null, InputOption::VALUE_OPTIONAL, 'File path'],
        ];
    }
