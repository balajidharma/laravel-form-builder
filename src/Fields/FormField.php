...
abstract class FormField
{
    ...
    {
        return [
            'wrapper' => ['class' => $this->getConfig('wrapper_class')],
            'attr' => ['class' => $this->getConfig('field_class')],
            'help_block' => [
                'text' => null,
                'tag' => $this->getConfig('help_block_tag', 'p'),
                'attr' => ['class' => $this->getConfig('help_block_class')],
            ],
            'value' => null,
            'default_value' => null,
            'label' => null,
