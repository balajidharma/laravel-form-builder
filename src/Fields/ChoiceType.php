...
class ChoiceType extends ParentType
{
    ...
    protected function setDefaultClasses(array $options = [])
    {
        ...
        $wrapper_class = $this->formHelper->getConfig($this->type.'.'.$choice_type.'_wrapper_class', '');
        if ($wrapper_class) {
        ...
        $choice_wrapper_class = $this->formHelper->getConfig(
            $this->type.'.choice_options.wrapper_class',
            $this->formHelper->getConfig($this->type.'.choice_options.'.$choice_type.'.wrapper_class', '')
        );
        $choice_label_class = $this->formHelper->getConfig(
            $this->type.'.choice_options.label_class',
            $this->formHelper->getConfig($this->type.'.choice_options.'.$choice_type.'.label_class', '')
        );
        $choice_field_class = $this->formHelper->getConfig(
            $this->type.'.choice_options.field_class',
            $this->formHelper->getConfig($this->type.'.choice_options.'.$choice_type.'.field_class', '')
        );
